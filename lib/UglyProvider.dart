...
class UglyProvider extends StatefulWidget {
  ...
  static _UglyProviderState of(BuildContext context, {bool subscribe = true}) {
    return subscribe
        ? (context.inheritFromWidgetOfExactType(_UglyProvider) as _UglyProvider).data
        : (context.ancestorInheritedElementForWidgetOfExactType(_UglyProvider).widget as _UglyProvider).data;
  }
}
